class GameSceneDrawer3 extends Phaser.Scene {
    constructor() {
    ...
    create() {
        ...
        if (!gameState.items.handle.found) {
            this.handleLayer = this.add.image(0, 0, 'handleLayer').setOrigin(0, 0);

            this.handleLayerHitArea = this.add.graphics();
            const handleLayerHitAreaPoints = [270, 90, 400, 110, 460, 380, 290, 300];
        ...
        this.navBelowArrowBConstructor('GameSceneDrawer3', 'GameScene2');
