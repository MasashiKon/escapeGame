class Shed2 extends Phaser.Scene {
    constructor() {
        super({key: 'Shed2'})
    }
    ...
    create() {
        ...
        this.messageHitArea = this.add.graphics();
        const messageHitAreaPoints = [280, 440, 450, 300, 490, 440];
       
        this.setHitArea(this.messageHitArea, messageHitAreaPoints, false);

        this.messageHitArea.on('pointerup', function() {
            
            this.messageHitArea.input.alwaysEnabled = false;
            this.message = this.add.image(0, 0, 'messageLayer').setOrigin(0, 0);

            this.messageLeaveHitArea = this.add.graphics();
            const messageLeaveHitAreaPoints = [0, 0, 800, 0, 800, 560, 0, 560];
           
            this.setHitArea(this.messageLeaveHitArea, messageLeaveHitAreaPoints, false);

            this.messageLeaveHitArea.on('pointerup', function() {

                this.messageHitArea.input.alwaysEnabled = true;
                this.message.destroy();
                this.messageLeaveHitArea.destroy();
        ...
        this.navBelowArrowBConstructor('Shed2', 'GameScene1');
