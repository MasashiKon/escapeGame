class Shed3 extends Phaser.Scene {
    constructor() {
        super({key: 'Shed3'})
    }
    ...
    create() {
        ...
        if (!gameState.items.protein.found) {

            this.proteinLayer = this.add.image(0, 0, 'proteinLayer').setOrigin(0, 0);

            this.proteinLayerHitArea = this.add.graphics();
            const proteinLayerHitAreaPoints = [310, 130, 550, 130, 550, 450, 310, 450];

            this.setHitArea(this.proteinLayerHitArea, proteinLayerHitAreaPoints, false);

            this.proteinLayerHitArea.on('pointerdown', function() {

                this.proteinLayer.destroy();
                this.proteinLayerHitArea.destroy();

                this.getItem('protein')
        ...
        this.navBelowArrowBConstructor('Shed3', 'GameScene1');
